...
function RecenterButton({ center }) {
  ...
  return (
    <button
      ...
      className="absolute bottom-45 md:bottom-35 right-4 z-[1000] bg-slate-800 hover:bg-slate-700 text-white p-4 rounded-xl shadow-2xl transition-all hover:scale-110 border border-slate-600"
      title="Recenter Map"
    >
...
export default function Map() {
  ...
  return (
    <div className="relative h-screen w-full bg-slate-900">
      ...
      {/* Enhanced Location Info  */}
      <div className="absolute bottom-35 md:bottom-22 left-4 z-[1000] bg-gradient-to-r from-blue-600 to-blue-700 text-white px-5 py-3 rounded-xl shadow-2xl border border-blue-500">
